...
/**
 * Created by yangjun on 2016/6/12.
 */
public class testClassUtil {
    ...
    private  List<Class> getClasses(String packageName) throws ClassNotFoundException,IOException {
        ...
        URL resource1 = classLoader.getResource(path);
        LogFactory.log("resource1 =" +resource1);
        Enumeration<URL> resources = classLoader.getResources(path);
        List<File> dirs = new ArrayList<File>();
        LogFactory.log("resources.hasMoreElements()="+resources.hasMoreElements());
    ...
    private  List<Class> findClass(File directory, String packageName)
